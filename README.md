...
- [Active chamber admin configuration goal](docs/CHAMBER_RESERVE_CHAMBER_ADMIN_CONFIGURATION_GOAL.md)
- [Completed implementation archive](docs/archive/2026-06-22-implemented/README.md)
...
実装結果と API / DB / 判定メモは `docs/archive/2026-06-22-implemented/CHAMBER_RESERVE_PHASE2_IMPLEMENTATION_SUMMARY.md` を参照する。
...
実装結果と Phase 4 への引き継ぎは `docs/archive/2026-06-22-implemented/CHAMBER_RESERVE_PHASE3_IMPLEMENTATION_SUMMARY.md` を参照する。
